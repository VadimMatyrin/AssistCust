...
namespace AssistCust.Persistance.Migrations
{
    ...
    [Migration("20191020121427_add-creation-date-field-to-attention-request")]
    partial class addcreationdatefieldtoattentionrequest
    {
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.Property<DateTime>("PurchaseTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2019, 10, 20, 12, 14, 26, 713, DateTimeKind.Utc).AddTicks(6624));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2019, 10, 20, 12, 14, 26, 720, DateTimeKind.Utc).AddTicks(3382));
