...
{
    public partial class Initwithauth : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2019, 10, 14, 7, 25, 9, 810, DateTimeKind.Utc).AddTicks(3690)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyShops_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseTime = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2019, 10, 14, 7, 25, 9, 801, DateTimeKind.Utc).AddTicks(7))
                },
                constraints: table =>
                {
