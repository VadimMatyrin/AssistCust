...
namespace AssistCust.Persistance.Migrations
{
    ...
    [Migration("20210503123646_companyshopid-iot3")]
    partial class companyshopidiot3
    {
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.IoTDevice", b =>
                {
                    ...
                    b.Property<DateTime?>("RegistrationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 3, 12, 36, 45, 689, DateTimeKind.Utc).AddTicks(173));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.Property<DateTime>("PurchaseTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 3, 12, 36, 45, 698, DateTimeKind.Utc).AddTicks(6030));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 3, 12, 36, 45, 701, DateTimeKind.Utc).AddTicks(2956));
