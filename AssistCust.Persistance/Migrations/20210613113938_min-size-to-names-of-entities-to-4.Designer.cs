...
namespace AssistCust.Persistance.Migrations
{
    ...
    [Migration("20210613113938_min-size-to-names-of-entities-to-4")]
    partial class minsizetonamesofentitiesto4
    {
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.IoTDevice", b =>
                {
                    ...
                    b.Property<DateTime?>("RegistrationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 13, 11, 39, 38, 287, DateTimeKind.Utc).AddTicks(1246));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.Property<DateTime>("PurchaseTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 13, 11, 39, 38, 294, DateTimeKind.Utc).AddTicks(1861));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 13, 11, 39, 38, 298, DateTimeKind.Utc).AddTicks(337));
