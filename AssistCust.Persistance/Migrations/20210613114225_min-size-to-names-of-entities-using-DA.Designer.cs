...
namespace AssistCust.Persistance.Migrations
{
    ...
    [Migration("20210613114225_min-size-to-names-of-entities-using-DA")]
    partial class minsizetonamesofentitiesusingDA
    {
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.IoTDevice", b =>
                {
                    ...
                    b.Property<DateTime?>("RegistrationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 13, 11, 42, 24, 993, DateTimeKind.Utc).AddTicks(9197));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.Property<DateTime>("PurchaseTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 13, 11, 42, 24, 999, DateTimeKind.Utc).AddTicks(8489));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 13, 11, 42, 25, 2, DateTimeKind.Utc).AddTicks(8486));
