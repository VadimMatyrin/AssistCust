...
namespace AssistCust.Persistance.Migrations
{
    ...
    [Migration("20191020122838_Add-resolve-date-to-AttentionRequest")]
    partial class AddresolvedatetoAttentionRequest
    {
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.Property<DateTime>("PurchaseTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2019, 10, 20, 12, 28, 38, 596, DateTimeKind.Utc).AddTicks(9397));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2019, 10, 20, 12, 28, 38, 604, DateTimeKind.Utc).AddTicks(7686));
