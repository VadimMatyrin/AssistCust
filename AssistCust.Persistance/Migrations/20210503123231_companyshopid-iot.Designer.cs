...
namespace AssistCust.Persistance.Migrations
{
    ...
    [Migration("20210503123231_companyshopid-iot")]
    partial class companyshopidiot
    {
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.IoTDevice", b =>
                {
                    ...
                    b.Property<DateTime?>("RegistrationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 3, 12, 32, 30, 897, DateTimeKind.Utc).AddTicks(9266));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.Property<DateTime>("PurchaseTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 3, 12, 32, 30, 903, DateTimeKind.Utc).AddTicks(7808));
            ...
            modelBuilder.Entity("AssistCust.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 3, 12, 32, 30, 908, DateTimeKind.Utc).AddTicks(2931));
